...
//     version 1.7.0
//     from Assets/SturdyMachine/Scripts/Inputs/SturdyMachineControls.inputactions
//
...
public partial class @SturdyMachineControls: IInputActionCollection2, IDisposable
{
    ...
    private List<IDeflectionActions> m_DeflectionActionsCallbackInterfaces = new List<IDeflectionActions>();
    ...
    public struct DeflectionActions
    {
        ...
        public void AddCallbacks(IDeflectionActions instance)
        {
            if (instance == null || m_Wrapper.m_DeflectionActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_DeflectionActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IDeflectionActions instance)
        {
            @Neutral.started -= instance.OnNeutral;
            @Neutral.performed -= instance.OnNeutral;
            @Neutral.canceled -= instance.OnNeutral;
        ...
        public void RemoveCallbacks(IDeflectionActions instance)
        {
            if (m_Wrapper.m_DeflectionActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IDeflectionActions instance)
        {
            foreach (var item in m_Wrapper.m_DeflectionActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_DeflectionActionsCallbackInterfaces.Clear();
    ...
    private List<ISweepActions> m_SweepActionsCallbackInterfaces = new List<ISweepActions>();
    ...
    public struct SweepActions
    {
        ...
        public void AddCallbacks(ISweepActions instance)
        {
            if (instance == null || m_Wrapper.m_SweepActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SweepActionsCallbackInterfaces.Add(instance);
            @Neutral.started += instance.OnNeutral;
            @Neutral.performed += instance.OnNeutral;
            @Neutral.canceled += instance.OnNeutral;
        }

        private void UnregisterCallbacks(ISweepActions instance)
        {
            @Neutral.started -= instance.OnNeutral;
            @Neutral.performed -= instance.OnNeutral;
            @Neutral.canceled -= instance.OnNeutral;
        ...
        public void RemoveCallbacks(ISweepActions instance)
        {
            if (m_Wrapper.m_SweepActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISweepActions instance)
        {
            foreach (var item in m_Wrapper.m_SweepActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SweepActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IStanceActions> m_StanceActionsCallbackInterfaces = new List<IStanceActions>();
    ...
    public struct StanceActions
    {
        ...
        public void AddCallbacks(IStanceActions instance)
        {
            if (instance == null || m_Wrapper.m_StanceActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_StanceActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IStanceActions instance)
        {
            @Strikes.started -= instance.OnStrikes;
            @Strikes.performed -= instance.OnStrikes;
            @Strikes.canceled -= instance.OnStrikes;
        ...
        public void RemoveCallbacks(IStanceActions instance)
        {
            if (m_Wrapper.m_StanceActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IStanceActions instance)
        {
            foreach (var item in m_Wrapper.m_StanceActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_StanceActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
